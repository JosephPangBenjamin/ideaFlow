...
import { IconHome, IconBulb, IconCheckCircle, IconApps, IconMenuFold, IconMenuUnfold, IconPoweroff } from '@arco-design/web-react/icon';
        ...
        <div className="flex h-screen bg-[#0f172a] overflow-hidden relative font-sans text-slate-100">
                    ...
                    >
                        ...
                        <div className="h-16 flex items-center justify-between px-6 border-b border-white/5 shrink-0">
                            ...
                            >
                                ...
                                <span className="text-lg font-semibold text-white font-heading tracking-tight drop-shadow-sm">IdeaFlow</span>
                            </motion.div>
                            ...
                            {navItems.map((item) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <motion.div
                                            className={`relative flex items-center px-4 py-3 rounded-xl text-sm font-medium transition-colors duration-200 ${isActive ? 'text-white' : 'text-slate-400 group-hover:text-slate-100 group-hover:bg-white/5'
                                                }`}
                                            whileHover={{ scale: 1.02, x: 2 }}
                                            whileTap={{ scale: 0.98 }}
                                        >
                                            <item.icon className={`w-5 h-5 mr-3 z-10 ${isActive ? 'text-blue-400' : 'text-slate-500 group-hover:text-slate-300'}`} />
                        ...
                        <div className="p-4 border-t border-white/5 shrink-0 flex items-center justify-between">
                            ...
                            >
                                ...
                                <div className="ml-3 overflow-hidden">
                                    <span className="text-sm font-medium text-slate-200 block truncate">{user?.username || '用户'}</span>
            ...
            <main className="flex-1 overflow-hidden relative z-10 flex flex-col">
                ...
                <header className="h-16 flex items-center px-6 shrink-0">
                    ...
                    <div className="text-sm font-medium text-slate-400/80">
                        {navItems.find(i => location.pathname.startsWith(i.path))?.label || 'IdeaFlow'}
                    </div>
                </header>
